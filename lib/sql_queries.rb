...
"select users.name, pledges.amount from users inner join pledges on users.id = pledges.user_id group by users.name order by sum(pledges.amount) ASC, users.name ASC;"
end
